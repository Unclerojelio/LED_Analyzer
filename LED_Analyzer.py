...
Modified by: Roger Banks 19 Aug 2021
Changed to work with current versions of Wire.h and matplotlib
'''
'''
...
def createPlot(currentDataList, voltageDataList):
    ...
    plot1, = plt.semilogx(currentAverageArray,voltageAverageArray,'r+', label = 'LED Forward Current Measured Characteristics')
    plot2, = plt.semilogx(fit_I,fit_V, label = 'Exponential Fit')
